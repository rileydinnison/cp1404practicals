...
# list comprehension to create a list of names in lowercase letters from the above list of names
...
large_last_names = [name.split()[1] for name in full_names if len(name) > 11]
